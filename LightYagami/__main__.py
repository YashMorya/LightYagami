...
from LightYagami import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
...
KIRA_IMG = "https://telegra.ph/file/4911c03742b50ad0d8bf7.jpg"
...
def main():
    ...
    if WEBHOOK:
        ...
        LOGGER.info("I Started Writing Names On <b>Death Note</b>")
