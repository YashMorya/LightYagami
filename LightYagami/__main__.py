...
from LightYagami.modules.helper_funcs.admin_rights import user_can_ban
...
PM_START_TEXT = """
Hello I Am Light Yagami The Person Who Tries To Give Justice To The Group.
I am an 𝐴𝑛𝑖𝑚𝑒 Themed Group Managing Bot and I will Help You Provide Justice To Your Group
...
buttons = [
    ...
    [
        ...
        url="t.me/I_Am_Justicebot?startgroup=true"),
    ]
]
...
Here You Can See M Power With These Power I Will Manage Your Group
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("LightYagami.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(Light_Img,
                PM_START_TEXT,
...
@run_async
def LightYagami_about_callback(update, context):
    query = update.callback_query
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*Hi again! The name's {dispatcher.bot.first_name}. \n\nAs  You I'm An Anime Themed Group Management Bot.* "
                 f"\n\n Join [Updates Channel](https://t.me/seedofbots) To Keep Yourself Updated About {dispatcher.bot.first_name}."
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                    ...
                    InlineKeyboardButton(text="Credits", callback_data="aboutmanu_tac")
                  ],
                 [
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} Is A Powerful Bot For Managing Groups With Additional Features.*"
                 f"\n\nMade With The Help Of [Saitama Robot](https://github.com/AnimeKaizoku/SaitamaRobot)'s Repo."
                 f"\n\nHere Is Light's Repo-: [Light's Repo](https://github.com/YashMorya/LightYagami)."
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(LightYagami_about_callback, pattern=r"aboutmanu_")
